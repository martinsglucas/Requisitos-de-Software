...
| 14  | R14 | RF   | O aplicativo deve permitir a alternação entre tema claro e escuro                      | OBS15, OBS16, ENT06, QST04 |
| 15  | R15 | RF   | O aplicativo deve possuir suporte para atalhos de gestos                               | OBS18                      |
| 16  | R16 | RF   | O aplicativo deve possibilitar a troca de conta do usuário                             | OBS20                      |
| 17  | R17 | RF   | O aplicativo deve permitir a alteração da senha da conta do usuário                    | OBS21                      |
| 18  | R18 | RF   | O aplicativo deve permitir ao usuário limpar seu histórico de navegação                | OBS22                      |
| 19  | R19 | RF   | O aplicativo deve permitir ao usuário limpar seus dados inseridos e de navegação       | OBS23                      |
| 20  | R20 | RF   | O aplicativo deve permitir a habilitação e bloqueio de notificações                    | OBS24                      |
| 21  | R21 | RF   | O aplicativo deve permitir alterar a fonte de texto em tipo e tamanho                  | OBS26, OBS19               |
| 22  | R22 | RF   | O aplicativo deve incluir opção de bloquear anúncios                                   | OBS27, BRS08, QST02        |
| 23  | R23 | RF   | O aplicativo deve incluir opção de busca interna na página                             | OBS28                      |
| 24  | R24 | RF   | O aplicativo deve incluir opção de pesquisa por voz                                    | OBS29                      |
| 25  | R25 | RF   | O aplicativo deve possuir opção de leitura da página em voz alta                       | OBS30, BRS11               |
| 26  | R26 | RF   | O aplicativo deve possuir opção de controle parental de acesso das páginas             | OBS32, BRS18               |
| 27  | R27 | RF   | O aplicativo deve oferecer opção de impressão de páginas                               | OBS33                      |
| 28  | R28 | RF   | O aplicativo deve conter opção de traduzir o idioma das páginas                        | OBS34, BRS10               |
| 29  | R29 | RF   | O aplicativo deve permitir sincronização de dados pessoais com a conta do Google       | ENT01, BRS07, QST01        |
| 30  | R30 | RF   | O aplicativo deve oferecer opção de navegação através de rede privada virtual (VPN)    | ENT03                      |
| 31  | R31 | RF   | O aplicativo deve simular, para desenvolvedores, suas aplicações em outros navegadores | ENT08                      |
| 32  | R32 | RF   | O aplicativo deve ser compatível com vários sistemas operacionais                      | BRS05, BRS20               |
...
| 36  | R36 | RNF  | O aplicativo deve apresentar um design arredondado                                     | ENT06                      |
| 37  | R37 | RNF  | O aplicativo deve possuir modo alternativo de cores para daltônicos                    | ENT07, BRS17, QST04        |
| 38  | R38 | RNF  | O aplicativo deve apresentar uma interface minimalista                                 | ENT09, QST06               |
| 39  | R39 | RNF  | O aplicativo deve ser rápido                                                           | BRS01                      |
| 40  | R40 | RNF  | O aplicativo deve gerir bem a memória                                                  | BRS02                      |
| 41  | R41 | RNF  | O aplicativo deve ser seguro                                                           | OBS36, OBS37, BRS16, BRS06 |
| 42  | R42 | RNF  | O aplicativo deve ser de fácil uso                                                     | BRS12, QST07, BRS21        |
