...
### Checklist da Especificação Suplementar
...
**Autor**: [Kauan Eiras](github.com/kauaneiras), **Verificado por**: [Kallyne Macedo](https://github.com/kalipassos) 

### Léxicos

**Tabela 4**: Checklist dos Léxicos

### Checklist da Léxicos
...
**Autor**: [Kauan Eiras](github.com/kauaneiras), **Verificado por**: [Kallyne Macedo](https://github.com/kalipassos), 2024

### Casos de Uso

<center> 

**Tabela 5**: Checklist dos Casos de Uso
...
| 04 | No diagrama, o ator principal fora do limite do sistema?                                                      | [MCTIC - CGSI, p. 5](../grupo_6/assets/image-17.png) |            |
| 05 | No diagrama, há a definição de atores primários e atores secundários?                                         | [LUCID Chart](../grupo_6/assets/image-3.png)         | Incompleto |
| 06 | No diagrama, o nome e/ou a especificação dos atores é significativa?                                          | [SERRANO, p. 13](../grupo_6/assets/image-4.png)      |            |
| 07 | No diagrama, a sinalização << system >> indica um software ou hardware?                                       | [SERRANO, p. 13](../grupo_6/assets/image-13.png)     |            |
| 08 | No diagrama, há pontos de extensão, inclusão e/ou generalização?                                              | [SERRANO, p. 23](../grupo_6/assets/image-14.png)     |            |
| 09 | No diagrama, os pontos de extensão, inclusão ou generalização são aplicados corretamente?                     | [SERRANO, p. 23](../grupo_6/assets/image-14.png)     |            |
| 10 | No diagrama, os casos de uso levantados representam requisitos?                                               | [SERRANO, p. 8](../grupo_6/assets/image-6.png)       |            |
| 11 | Na especificação, os casos de uso levantados representam corretamente as funcionalidades e suas interações    | [MCTIC - CGSI, p. 4](../grupo_6/assets/image-7.png)  |            |
| 12 | Na especificação, há a definição correta das pré e pós-condições dos casos de uso?                            | [MCTIC - CGSI, p. 5](../grupo_6/assets/image-5.png)  |            |
| 13 | Na especificação, há a definição correta dos atores dos casos de uso e de seu escopo?                         | [MCTIC - CGSI, p. 5](../grupo_6/assets/image-8.png)  |            |
| 14 | Na especificação, há a definição de apenas um fluxo principal para cada caso de uso?                          | [MCTIC - CGSI, p. 5](../grupo_6/assets/image-9.png)  |            |
| 15 | Na especificação, os fluxos alternativos são factívelmente alternativos ao principal?                         | [MCTIC - CGSI, p. 6](../grupo_6/assets/image-11.png) |            |
| 16 | Na especificação, os fluxos de exceção representam a reação do sistema a erros ou situações fora do esperado? | [MCTIC - CGSI, p. 7](../grupo_6/assets/image-12.png) |            |
| 17 | Na especificação, a validação do diagrama de casos de uso foi realizada com um usuário?                       | [SERRANO, p. 19](../grupo_6/assets/image-15.png)     |            |
| 18 | Na especificação, na validação do diagrama, há a especificação da técnica utilizada?                          | [SERRANO, p. 19](../grupo_6/assets/image-16.png)     |            |

**Autor**: [Kallyne Macedo](https://github.com/kalipassos), **Verificado por**:  [Kauan Eiras](github.com/kauaneiras), 2024
...
| ID | Pergunta                                                                                                                         | Referência                                                    | Avaliação |
|----|----------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|-----------|
| 01 | Cada cenário possui um título claro e fácil de entender, objetivo, contexto, atores, recursos, restrições, exceções e episódios? | [BARBOSA, SILVA, 2021, p. 172](../grupo_6/assets/imageC5.png) |           |
| 02 | Os cenários são testáveis?                                                                                                       | [BARBOSA, SILVA, 2021, p. 172](../grupo_6/assets/imageC1.png) |           |
| 03 | Existem cenários que conjuntamente se complementam?                                                                              | [LEITE, p.52-53](../grupo_6/assets/imageC7.png)               |           |
| 04 | Os cenários descrevem interações realistas e significativas com o sistema?                                                       | [BARBOSA, SILVA, 2021, p. 173](../grupo_6/assets/imageC3.png) |           |
| 05 | Os atores são apropriados e relevantes para o contexto dos cenários?                                                             | [BARBOSA, SILVA, 2021, p. 172](../grupo_6/assets/imageC2.png) |           |
| 06 | Há um episódio/evento relacionado a cada um dos cenários?                                                                        | [BARBOSA, SILVA, 2021, p. 172](../grupo_6/assets/imageC.png)  |           |
| 07 | Há uma referência clara aos léxicos nos cenários?                                                                                | [LEITE, p. 50](../grupo_6/assets/imageC4.png)                 |           |
| 08 | O artefato menciona as técnicas utilizadas para desenvolver os cenários?                                                         | [LEITE, p.48-49](../grupo_6/assets/imageC6.png)               |           |
| 09 | A introdução ou metodologia trazem referências que justifiquem a forma que o trabalho foi desenvolvido?                          | [LEITE, p.48-49](../grupo_6/assets/imageC6.png)               |           |
