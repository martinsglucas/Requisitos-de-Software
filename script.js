window.$docsify.plugins = [].concat((e, o) => {
  let t = {
    ...
    bodyFontSize: "17px",
    dark: {
      accent: "#FF9500", // Laranja Firefox
      toogleBackground: "#ffffff",
      background: "#232931", // Cinza escuro
      textColor: "#e0e0e0",
  ...
  if (o.config.hasOwnProperty("darklightTheme")) {
    for (var [r, l] of Object.entries(o.config.darklightTheme)) {
      ...
      for (var [r, l] of Object.entries(t)) {
        "light" !== r && "dark" !== r && (t[r] = l, document.documentElement.style.setProperty("--" + r, l));
      }
  ...
  window.matchMedia("(prefers-color-scheme: dark)").matches
    ? (t.defaultTheme = "dark")
    : window.matchMedia("(prefers-color-scheme: light)").matches && (t.defaultTheme = "light");
